    ...
    >
      <RouterLink :to="{ name: 'home' }">
        <div class="flex items-center gap-3">
          <span class="material-icons text-2xl">brightness_high</span>
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <span
          @click="toggleModal"
          class="material-icons text-xl hover:text-weather-secondry duration-150 cursor-pointer"
        >
          info</span
        >
        <span
...
export default {
  components: { BaseModal, RouterLink },
  setup() {
